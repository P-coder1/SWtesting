...
@Category(FunctionGroup3Test.class) // 인터페이스를 만들고 지정을함
public class WeiredAddlnSimpleCalculatorTestCT3 {
	...
	//생성자
	public WeiredAddlnSimpleCalculatorTestCT3(int expected, 
